  ...
  <body>
    <nav>
      ...
      <ul class="nav__links">
        ...
        <li class="link"><a href="planin.php">Plan</a></li>
    ...
    <section class="section__container price__container">
        <h2 class="section__header">JOIN US AND BECOME A MEMBER</h2>
        ...
        <div class="price__grid">
          <div class="price__card">
            ...
            <button class="btn price__btn"><li class="link"><a href="Weekly.php">Join Now</a></li></button>
          </div>
          <div class="price__card">
            <div class="price__card__content">
              <h4>Monthly Plan</h4>
            ...
            <button class="btn price__btn"><li class="link"><a href="Monthly.php">Join Now</a></li></button>
          </div>
          <div class="price__card">
            <div class="price__card__content">
              <h4>Annual Plan</h4>
            ...
            <button class="btn price__btn"><li class="link"><a href="Annual.php">Join Now</a></li></button>
          </div>
        </div>
      </section>
